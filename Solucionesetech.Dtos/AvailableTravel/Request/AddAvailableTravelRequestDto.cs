...
{
    public class AddAvailableTravelRequestDto
    {
    ...
    public class AddAvailableTravelRequestValidator : AbstractValidator<AddAvailableTravelRequestDto>
    {
        public AddAvailableTravelRequestValidator()
        {
